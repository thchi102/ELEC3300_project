...
static void ILI9341_DrawCross ( uint16_t usX, uint16_t usY )
{
	LCD_DrawLine(usX-10,usY,usX+10,usY, RED);
	LCD_DrawLine(usX, usY - 10, usX, usY+10, RED);
}
...
//	char xcorr[4]="";
//	char ycorr[4]="";
//	sprintf(xcorr,"%03d", touch->x);
//	sprintf(ycorr,"%03d", touch->y);
//	LCD_DrawString(0, 0,  "            X    Y", BLACK, WHITE);
//	LCD_DrawString(90, 15, xcorr, BLACK, WHITE);
//	LCD_DrawString(150, 15, ycorr, BLACK, WHITE);
//	if (stage == "menu")
//	{
//		if (touch->pre_x < 150 && touch->pre_y < 150)
//		{
//			stage = "Read_menu";
//		}
//	}
